...
namespace KFQS_Form
{
    public partial class PP_BadList : DC00_WinForm.BaseMDIChildForm
    {
        ...
        private void PP_BadList_Load(object sender, EventArgs e)
        {
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "BADQTYTOTAL", "최초불량수량", true, GridColDataType_emu.Double, 140, 120, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "NOWBADQTY", "현재불량수량", true, GridColDataType_emu.Double, 140, 120, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "PRODQTY", "재검양품수량", true, GridColDataType_emu.Double, 140, 120, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "PRODRATIO", "불량해결률", true, GridColDataType_emu.Double, 140, 120, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "CHECKNUM", "재검사횟수", true, GridColDataType_emu.VarChar, 100, 120, Infragistics.Win.HAlign.Left, true, false);
