...
namespace KFQS_Form
{
    public partial class PP_BadCheckList : DC00_WinForm.BaseMDIChildForm
    {
        ...
        private void PP_BadCheckList_Load(object sender, EventArgs e)
        {
            ...
            _GridUtil.InitColumnUltraGrid(grid2, "BADQTYTOTAL", "최초불량수량", true, GridColDataType_emu.Double, 140, 120, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid2, "NOWBADQTY", "현재불량수량", true, GridColDataType_emu.Double, 140, 120, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid2, "PRODQTY", "재검양품수량", true, GridColDataType_emu.Double, 140, 120, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid2, "PRODRATIO", "불량해결률", true, GridColDataType_emu.VarChar, 140, 120, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid2, "CHECKNUM", "재검사횟수", true, GridColDataType_emu.Integer, 100, 120, Infragistics.Win.HAlign.Left, true, false);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                if (rtnDtTemp.Rows.Count != 0)
                {
                    ...
                    DataTable dtSubTotal2 = rtnDtTemp.Clone();


                    string sItemCode2 = Convert.ToString(rtnDtTemp.Rows[0]["ITEMCODE"]);
                    string sBadtypepe = Convert.ToString(rtnDtTemp.Rows[0]["BADTYPE"]);
                    double sProdqty = Convert.ToDouble(rtnDtTemp.Rows[0]["BADQTYTOTAL"]); //- Convert.ToDouble(rtnDtTemp.Rows[0]["NOWBADQTY"]);
                    ...
                    string sBaaadType = Convert.ToString(rtnDtTemp.Rows[0]["BADTYPE"]);
                    ...
                    for (int i = 1; i < rtnDtTemp.Rows.Count; i++)
                    {
                        ...
                        {
                            //sProdqty = sProdqty + Convert.ToDouble(rtnDtTemp.Rows[i]["BADQTYTOTAL"]); //- Convert.ToDouble(rtnDtTemp.Rows[i]["NOWBADQTY"]);
                        ...
                        else
                        {
                            ...
                            sBaaadType = Convert.ToString(rtnDtTemp.Rows[i]["BADTYPE"]);
                            dtSubTotal.Rows.Add(new object[] { Convert.ToString(rtnDtTemp.Rows[i]["PLANTCODE"]),
                                                               Convert.ToString(rtnDtTemp.Rows[i]["INLOTNO"]),
                                                               Convert.ToDouble(rtnDtTemp.Rows[i]["BADQTYTOTAL"]),
                                                               Convert.ToDouble(rtnDtTemp.Rows[i]["NOWBADQTY"]),
                        ...
                        if (sBadtypepe == Convert.ToString(rtnDtTemp.Rows[i]["BADTYPE"]))
                        {
                            //sProdqty = sProdqty + Convert.ToDouble(rtnDtTemp.Rows[i]["BADQTYTOTAL"]); //- Convert.ToDouble(rtnDtTemp.Rows[i]["NOWBADQTY"]);
                            sBadqty = sBadqty + Convert.ToDouble(rtnDtTemp.Rows[i]["NOWBADQTY"]);
                            sBADTOTAL = sBADTOTAL + Convert.ToDouble(rtnDtTemp.Rows[i]["BADQTYTOTAL"]);
                            sCheckNum = sCheckNum + Convert.ToInt32(rtnDtTemp.Rows[i]["CHECKNUM"]);
                            dtSubTotal2.Rows.Add(new object[] {Convert.ToString(rtnDtTemp.Rows[i]["PLANTCODE"]),
                                                               Convert.ToString(rtnDtTemp.Rows[i]["INLOTNO"]),
                                                               Convert.ToDouble(rtnDtTemp.Rows[i]["BADQTYTOTAL"]),
                                                               Convert.ToDouble(rtnDtTemp.Rows[i]["NOWBADQTY"]),
                                                               Convert.ToDouble(rtnDtTemp.Rows[i]["PRODQTY"]),
                        ...
                        {
                            dtSubTotal2.Rows.Add(new object[] { "", "", sBADTOTAL, sBadqty, sBADTOTAL - sBadqty, Convert.ToString(Math.Round((sBADTOTAL - sBadqty) * 100 / sBADTOTAL, 1)) + " %", sCheckNum, "", "", sBaaadType });
                            sProdqty = Convert.ToDouble(rtnDtTemp.Rows[i]["BADQTYTOTAL"]);
                            sBadqty = Convert.ToDouble(rtnDtTemp.Rows[i]["NOWBADQTY"]);
                            sBADTOTAL = Convert.ToDouble(rtnDtTemp.Rows[i]["BADQTYTOTAL"]);
                            sCheckNum = Convert.ToInt32(rtnDtTemp.Rows[i]["CHECKNUM"]);
