...
namespace KFQS_Form
{
    public partial class AP_ProductPlan : DC00_WinForm.BaseMDIChildForm
    {
        ...
        private void AP_ProductPlan_Load(object sender, EventArgs e)
        {
            ...
            //S/M : 부자재(H / W)
            //SFP : 반제품
            rtnDtTemp = _Common.GET_ItemCodeFERT_Code("FERT"); // FERT는 완제품의 속성. 완제품만 가져와서 콤보 박스에 채우기
        ...
        private void DoFind()
        {
            ...
            try
            {
                ...
                string sWorkcenterCode = Convert.ToString(this.cboWorkcenterCode_H.Value);
                string sOrderNo        = Convert.ToString(txtOrderNo.Text);
                string sOrderCloseFlag = Convert.ToString(cboOrderCloseFlag.Value);

                rtnDtTemp = helper.FillTable("17AP_ProductPlan_S1", CommandType.StoredProcedure
                ...
                foreach (DataRow drRow in dtTemp.Rows)
                {
                    switch (drRow.RowState)
                    {
                        case DataRowState.Deleted:
                            #region 삭제
                            drRow.RejectChanges();
                            helper.ExecuteNoneQuery("17AP_ProductPlan_D1", CommandType.StoredProcedure
                        ...
                        case DataRowState.Added:
                            ...
                            helper.ExecuteNoneQuery("17AP_ProductPlan_I1", CommandType.StoredProcedure
                        ...
                        case DataRowState.Modified:
                            ...
                            helper.ExecuteNoneQuery("17AP_ProductPlan_U1", CommandType.StoredProcedure
                                                  , helper.CreateParameter("PLANTCODE", drRow["PLANTCODE"].ToString(), DbType.String, ParameterDirection.Input)
