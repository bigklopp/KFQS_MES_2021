...
namespace KFQS_Form
{
    public partial class PP_BadList : DC00_WinForm.BaseMDIChildForm
    {
        ...
        private void PP_BadList_Load(object sender, EventArgs e)
        {
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "",       "판정결과", true, GridColDataType_emu.VarChar,   100, 120, Infragistics.Win.HAlign.Left,  true, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "WORKCENTERCNAME",     "작업장",     true, GridColDataType_emu.VarChar,  120, 120, Infragistics.Win.HAlign.Left,  true, false);
